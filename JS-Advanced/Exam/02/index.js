class ChristmasMovies {
  ...
  favouriteMovie() {
    ...
    if (favourite.length > 0) {
      return `Your favourite move is ${favourite[0][0]} and you have watched it ${favourite[0][1]} times!`;
    } else {
...
christmas.buyMovie("Home Alone 2", ["Macaulay Culkin"]); // christmas.buyMovie("Last Christmas", ["Emilia Clarke", "Henry Golding"]);
console.log(christmas.buyMovie("The Grinch", ["Benedict Cumberbatch", "Pharrell Williams"])
)// christmas.watchMovie("Home Alone");
// christmas.watchMovie("Home Alone");
// christmas.watchMovie("Home Alone");
console.log(christmas.watchMovie("Home Alone 2"));
christmas.watchMovie("The Grinch");
// christmas.watchMovie("Last Christmas");
// christmas.watchMovie("Home Alone 2");
console.log(christmas.discardMovie("Home Alone 2")); 
